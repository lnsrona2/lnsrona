...
#define levmax     7              // maximum depth of block nesting
...
//**************************************************************************************
char lstch;            //new define, the last character of ch
...
short lev;		// current depth of block nesting
